...
class Kealoa_Formatter {
     ...
     *
     * Removes all non-alphanumeric characters except hyphens from the name to form the image filename.
     * Example: "Joel Fagliano" => "https://www.xwordinfo.com/images/cons/JoelFagliano.jpg"
     * Example: "Tracy Bennett-Coe" => "https://www.xwordinfo.com/images/cons/TracyBennett-Coe.jpg"
     *
